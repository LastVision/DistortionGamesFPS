...
InputComponent::InputComponent(Entity& anEntity, Prism::Scene* aScene)
	: myAlive(true)
...
void InputComponent::UpdateAnimation(float aDelta)
{
...
bool InputComponent::IsCurrentAnimationDone() const
{
	return myModel->IsAnimationDone();
}

void InputComponent::RestartCurrentAnimation()
{
	myModel->ResetAnimationTime(0.f);
}

void InputComponent::AddAnimation(ePlayerState aState, const std::string& aAnimationPath
...
void InputComponent::PlayAnimation(ePlayerState aAnimationState)
{
...
void InputComponent::AddIntention(ePlayerState aPlayerState, bool aClearIntentions)
{
